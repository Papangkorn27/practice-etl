...
from cassandra.cluster import Cluster  #package cassandra in python


table_drop = "DROP TABLE events"
#create table name events collect id,type,public
table_create = """
...
def main():
    cluster = Cluster(['127.0.0.1']) #connext cassandra local host
